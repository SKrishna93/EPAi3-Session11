...
def test_polygon():
    ...
    p1 = regular_polygon(3, 10)
    p2 = regular_polygon(10, 10)
    p3 = regular_polygon(15, 10)
    p4 = regular_polygon(15, 100)
    p5 = regular_polygon(15, 100)
